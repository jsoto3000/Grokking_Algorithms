# Merge Sort
# Source: https://towardsdatascience.com/how-to-implement-merge-sort-algorithm-in-python-4662a89ae48c
...
def run_merge_sort():
    ...
    print("Given unsorted array:", unsorted_list)
    sorted_list = merge_sort(unsorted_list)
    print("Outputs a sorted array using a Merge Sort function:", sorted_list)
